...
<body>
    ...
    <nav class="nav">
        ...
        <a class="active" href="./course_marks.aspx">Marks</a>
            ...
            <div class="box">
                ...
                <form runat="server" id="form1">  
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="AssignmentWeight" HeaderText="Assignment" />
                        <asp:BoundField DataField="QuizzesWeight" HeaderText="Quiz" />
                        <asp:BoundField DataField="Mid1Weight" HeaderText="Mid1" />
                        <asp:BoundField DataField="Mid2Weight" HeaderText="Mid2" />
                        <asp:BoundField DataField="FinalWeight" HeaderText="Final" />
                        <asp:BoundField DataField="Total" HeaderText="Final" />
