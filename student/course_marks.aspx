<%@ Page Language="C#" AutoEventWireup="true" CodeFile="course_marks.aspx.cs" Inherits="student_course_marks" %>
...
<body>
    ...
    <div class="box-container">
        ...
        <h3>Marks</h3>
            ...
            <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" runat="server" Text="Check Marks" NavigateUrl='<%# "marks.aspx?id=" + Eval("sID") %>'></asp:HyperLink>
            </ItemTemplate>
        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
