<%@ Page Language="C#" AutoEventWireup="true" CodeFile="feedback_course.aspx.cs" Inherits="student_feedback_course" %>
        ...
        <h3>Course Feedback</h3>
            ...
            <div class="box">
                ...
                <form runat="server" id="form1">      
                    <asp:GridView CssClass="table table-condensed table-hover" runat="server" ID="myGridView" AutoGenerateColumns="false" OnSelectedIndexChanged="myGridView_SelectedIndexChanged">
                    <Columns>
                        <asp:BoundField DataField="courseTitle" HeaderText="Courses" />
                                <asp:TemplateField HeaderText="Link">
            <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" runat="server" Text="Feedback Form" NavigateUrl='<%# "feedback.aspx?id=" + Eval("sID") %>'></asp:HyperLink>
            </ItemTemplate>
        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
