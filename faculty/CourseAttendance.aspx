<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseAttendance.aspx.cs" Inherits="CourseAttendance" %>
...
<body>
    <nav class="nav">
        ...
        <a class="active" href="/faculty/CourseAttendance.aspx">Attendance</a>
                        ...
                        <asp:GridView ID="showAllAssignment" runat="server" class="gridview" AutoGenerateColumns="FALSE">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Course Info">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="Course_Section" runat="server" Text="Click" NavigateUrl='<%# "Attendance.aspx?SID=" + Eval("Section") + "&CID=" + Eval("CourseTitle") %>'></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
