...
public partial class courseFeedback : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string query = "Select s.sectionID, CC.CourseTitle, S.SectionName as Section,  CONCAT(U.FIRST_NAME, ' ', U.LAST_NAME) as Teacher from CourseInstructors CI join Sections S on CI.CourseID = S.CourseID and CI.InstructorID = @IDD and CI.InstructorID = S.CourseInstruct_ID join Course CC on CC.CourseID = S.CourseID join Instructor I on CI.InstructorID = I.InstructorID join USERS U on U.USER_ID = I.USER_ID;";
