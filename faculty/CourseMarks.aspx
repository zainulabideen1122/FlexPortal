<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseMarks.aspx.cs" Inherits="CourseMarks" %>
                            ...
                            <asp:GridView ID="showAllAssignment" runat="server" class="gridview" AutoGenerateColumns="FALSE">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Course Info">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="Course_Section" runat="server" Text="Click" NavigateUrl='<%# "Marks.aspx?SID=" + Eval("Section") + "&CID=" + Eval("CourseTitle") %>'></asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
